...
struct ProfileEditorView: View {
            ...
            Section("Metadata") {
                LabeledContent("Type") {
                    Text(profile.type == .remote ? "Remote" : "Local")
                        .foregroundStyle(
                            profile.type == .remote ? .blue : .orange
                        )
                ...
                LabeledContent("Last Updated") {
                    Text(
                        DateFormatters.mediumDateTime.string(
    ...
    private func saveProfile() {
        ...
        updatedProfile.userAgent =
            profileUserAgent.isEmpty ? "ClashForMacOS/1.0" : profileUserAgent
        ...
        do {
            let normalizedContent = try ProfileManager.shared
                .validateAndNormalizeYAML(profileContent)
            ProfileManager.shared.saveProfileContent(
                updatedProfile,
...
class LineNumberRulerView: NSRulerView {
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        while index < characterRange.location + characterRange.length {
            ...
            lineRect.origin.y +=
                textView.textContainerInset.height - visibleRect.origin.y
